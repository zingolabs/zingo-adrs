...
superseded by [ADR-0050](0050-indexers-are-classified-by-role-trust-and-location.md)

Restored from zingolib's history, where it was numbered 0050. Commit
`30b037ee9` folded the decision into the indexer classification record
and reused the number, deleting this record instead of superseding it.
