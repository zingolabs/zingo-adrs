...
superseded by [ADR-0006](0006-wallet-stored-proposal.md)

Restored from zingolib's history, where it was numbered 0006. Commit
`ab50dacbc` withdrew the decision and reused the number for the
wallet-stored proposal, deleting this record instead of superseding it.
